...
import physical from "../img/strong.svg";
import mental from "../img/brain.svg";
import skills from "../img/lightbulb.svg";
import gaming from "../img/gamepad.svg";
  ...
  render() {
    ...
    return (
      <div className="form-group">
        <label className="formlabel h2" htmlFor="hoursplaying">
          How many hours do you spend playing in a day?
        </label>
        ...
        <div className="streaming">
          <label htmlFor="streaming" className="h2">
...
export class Step2 extends React.Component {
  render() {
    ...
    return (
      <div className="form-group">
        <h1 className="h2">What areas would you like to improve?</h1>
        <div className="icon-areas">
          <img src={physical} alt="physical"></img>
        </div>
...
export class Step5 extends React.Component {
  render() {
    ...
    return (
      <div className="form-group">
        <h1 className="h2">What areas would you like to improve?</h1>
        <div className="icon-areas gamingicon">
...
export class Step6 extends React.Component {
  render() {
    ...
    return (
      <div className="form-group">
        <label htmlFor="pick-games" className="formlabel h2">
...
export class Step8 extends React.Component {
  render() {
    ...
    return (
      <div className="form-group">
        <h1 className="h2">What type of content would you want to receive?</h1>
